...
BEGIN
    ...
    CASE _levelid
        WHEN 1,2,3,4,5,6,7,8 THEN -- адрес 1 - Субъект РФ, 
            ...
            ELSIF ( _address_format in (5) ) and ( _levelid in (4,5,6,7,8) ) THEN
            ELSIF ( _address_format in (6) ) and ( _levelid in (1,2,3,7,8) ) THEN
            ELSE
