...
DECLARE
    ...
    _prefix text;
BEGIN
    IF _address_format NOT BETWEEN 1 AND 9 THEN
       ...
       8 - дом, квартира, комната, парковочное место или участок (9-12,17)
       9 - объект без иерархии
       третий параметр (название типов объектов): true - аббревиатуры, false - полные наименования, null - не выводить вообще';
    END IF;
    IF _debug > 5 THEN
    ...
    -- 9 это без иерархии, вызывать рекурсию не надо
    IF ( _address_format = 9 ) THEN
        _rt := _name;
    ELSE
